...
namespace Modules\UBForms\Providers;
...
class UBFormsServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'UBForms';

    protected string $nameLower = 'ubforms';
