...
<head>
  ...
  <title>End of Shift Report (Patrol Officer)</title>
    ...
    <div class="section">
      ...
      <div class="section-content">
        <div class="info-row">
          ...
          <span class="info-value">{{ $patrolReport['date'] ?? 'N/A'}}</span>
        </div>
        <div class="info-row">
          <span class="info-label">Time: </span>
          <span class="info-value">{{ $patrolReport['time'] ?? 'N/A'}}</span>
        </div>
        <div class="info-row">
          <span class="info-label">Campus: </span>
          <span class="info-value">{{ $patrolReport['campus'] ?? 'N/A'}}</span>
        </div>
        <div class="info-row">
          <span class="info-label">Report: </span>
          <span class="info-value">{{ $patrolReport['report'] ?? 'N/A'}}</span>
        </div>
        <div class="info-row">
          <span class="info-label">Public Safety Officer </span>
          <span class="info-value">{{ $patrolReport['uploadedBy'] ?? 'N/A'}}</span>
        </div>
      </div>
    </div>
