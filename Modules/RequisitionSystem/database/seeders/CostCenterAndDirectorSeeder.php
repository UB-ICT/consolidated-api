...
class CostCenterAndDirectorSeeder extends Seeder
{
    ...
    {
        // Synced from current DB directors. Roles are assigned only by UserRoleSeeder.
        $matrix = [
            ...
            ['cc' => 'Board of Trustees', 'number' => '003', 'name' => 'Vincent Palacio', 'email' => 'vpalacio@ub.edu.bz'],
            ['cc' => 'Budget and Finance', 'number' => '004', 'name' => 'Irene Garcia', 'email' => 'igarcia@ub.edu.bz'],
            ...
            ['cc' => 'Information and Communication Technology', 'number' => '013', 'name' => 'Luis Herrera', 'email' => 'luis.herrera@ub.edu.bz'],
            ...
            ['cc' => 'President', 'number' => '022', 'name' => 'Vincent Palacio', 'email' => 'vpalacio@ub.edu.bz'],
        ...
        // Additional cost-center grants that don't fit the one-director pattern.
        $additionalGrants = [
            [
                'name' => 'James Faber',
