...
class CountryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $country = Country::create($payload);
        return response()->json(['message' => 'Item created successfully!', 'data' => $country], 201);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['message' => 'Updated!', 'data' => $country]);
    }
