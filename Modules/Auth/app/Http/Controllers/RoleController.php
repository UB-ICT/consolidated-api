...
class RoleController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'role_name' => 'required|string|max:255|unique:pgsql.roles,role_name',
    ...
    public function update(Request $request, Role $role): JsonResponse
    {
        ...
        $data = $request->validate([
             ...
             */
            'role_name' => 'sometimes|required|string|max:255|unique:pgsql.roles,role_name,' . $role->id,
    ...
    public function attachPermissions(Request $request, Role $role): JsonResponse
    {
        $data = $request->validate([
            ...
            'permission_ids.*' => 'required|uuid|exists:pgsql.permissions,id',
        ]);
